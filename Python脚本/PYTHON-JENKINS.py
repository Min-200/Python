...
import time
import os
server = jenkins.Jenkins('http://192.168.1.1:8080/jenkins/', username='shiminde', password='112233')
...
url=os.popen("ssh 192.168.104.187 cat {}/{}.txt".format(url_file,job_basename)).readlines()
package_url=[]
for i in url:
        #print i
        q=i.replace('\n','')
